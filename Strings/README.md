...
![First if-block conditions](img/image-1.png)
...
![Decryption Logic](img/image-6.png)
...
![AES Key](img/image-4.png)

![AES IV](img/image-5.png)
...
![CyberChef Decryption](img/image-2.png)
...
![Toast Success Message](img/image-7.png)
...
![Flag in Memory](img/image-9.png)